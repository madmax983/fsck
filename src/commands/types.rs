...
impl Command {
    ...
    pub fn from_input<'a>(command: &str, mut args: impl Iterator<Item = &'a str>) -> Self {
        match command {
            c if c.eq_ignore_ascii_case("CATALOG") || c.eq_ignore_ascii_case("DIR") || c.eq_ignore_ascii_case("LS") => Self::Catalog,
            ...
            c if c.eq_ignore_ascii_case("HOME") || c.eq_ignore_ascii_case("CLS") || c.eq_ignore_ascii_case("CLEAR") => Self::Home,
            ...
            c if c.eq_ignore_ascii_case("QUIT") || c.eq_ignore_ascii_case("EXIT") || c.eq_ignore_ascii_case("BYE") => Self::Quit,
