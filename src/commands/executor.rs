...
impl CommandExecutor {
    ...
    fn handle_nova_commands(&self, cmd: &str) -> Option<CommandResult> {
        ...
        {
            match (cmd_word, arg) {
                (c, a) if !a.is_empty() && (c.eq_ignore_ascii_case("SPEAK") || c.eq_ignore_ascii_case("SAY")) => Some(self.handle_nova_speak(a)),
                ...
                (c, "") if c.eq_ignore_ascii_case("LIFE") || c.eq_ignore_ascii_case("AUTOMATON") => {
                    #[cfg(feature = "nova")]
                    {
                ...
                (c, a) if !a.is_empty() && c.eq_ignore_ascii_case("ANALYZE") => {
                    #[cfg(feature = "nova")]
                    {
                ...
                (c, "") if c.eq_ignore_ascii_case("MAIL") => {
                    #[cfg(feature = "nova")]
                    {
                ...
                (c, a) if !a.is_empty() && (c.eq_ignore_ascii_case("SEARCH") || c.eq_ignore_ascii_case("FIND")) => Some(self.handle_nova_search(a)),
                ...
                (c, a) if !a.is_empty() && c.eq_ignore_ascii_case("PING") => Some(self.handle_nova_ping(a)),
                (c, a) if !a.is_empty() && (c.eq_ignore_ascii_case("DIAL") || c.eq_ignore_ascii_case("CALL")) => Some(self.handle_nova_dial(a)),
                (c, a) if !a.is_empty() && (c.eq_ignore_ascii_case("DUMP") || c.eq_ignore_ascii_case("HEXDUMP")) => Some(self.handle_nova_dump(a)),
                (c, a) if !a.is_empty() && (c.eq_ignore_ascii_case("TRACE") || c.eq_ignore_ascii_case("TRACEROUTE")) => Some(self.handle_nova_trace(a)),
                (c, a) if !a.is_empty() && c.eq_ignore_ascii_case("STAT") => Some(self.handle_nova_stat(a)),
