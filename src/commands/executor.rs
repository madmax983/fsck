...
impl CommandExecutor {
    ...
    fn handle_nova_commands(&self, cmd: &str) -> Option<CommandResult> {
        ...
        match (cmd_word, arg) {
            ...
            (c, "") if c.eq_ignore_ascii_case("PS") || c.eq_ignore_ascii_case("TOP") || c.eq_ignore_ascii_case("TASKS") => {
            ...
            (c, "") if c.eq_ignore_ascii_case("DEFRAG") => {
            ...
            (c, "") if c.eq_ignore_ascii_case("NETSTAT") => {
            ...
            (c, "") if c.eq_ignore_ascii_case("SENSORS") || c.eq_ignore_ascii_case("SENSE") || c.eq_ignore_ascii_case("TEMP") => {
            ...
            (c, "") if c.eq_ignore_ascii_case("FORTUNE") => {
                Some(self.handle_nova_fortune())
            }
            (c, "") if c.eq_ignore_ascii_case("WHOAMI") => {
