...
impl CommandExecutor {
    ...
    fn handle_nova_commands(&self, cmd: &str) -> Option<CommandResult> {
        ...
        } else if (cmd_word.eq_ignore_ascii_case("TREE") || cmd_word.eq_ignore_ascii_case("MAP"))
            && arg.is_empty()
        {
    ...
    fn handle_nova_tree(&self) -> CommandResult {
        let output =
            crate::experimental::TopologicalCartographer::generate_map(&self.entity, 0xF5C0_0000);
